...
def native_delete_compatibility(
    *,
    ...
    # Destructive operation: unknown environment is fail-closed.
    if version_error:
    ...
    if result[
        ...
        result[
            ...
            "PINNED_01444_PRE42_STATE_COMPATIBLE"
        )
    ...
    if (
        ...
        result[
            ...
            "PINNED_01444_POST42_STATE_INCOMPATIBLE"
        )
